...
public class StartScenControllers : IExecute, IInitialization, ILateExecute, ICleanup, IFixedExecute, IAwake
{
    ...
    internal StartScenControllers Add(IController controller)
    {
